...
/**
 * Created by x64 on 6/27/2016.
 */
public class SubscriptionAPI {



    public static void subscriptionSetup(final Context mContext, final Map<String,String> parameters , final NetworkCallbackResult callbackResult){
    ...
    public static void updateSubscription(final Context mContext, final Map<String,String> parameters , final NetworkCallbackResult callbackResult){
